...
/**
 * PaymentP201705 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "payment_p2017_05", schema = "public")

public class PaymentP201705 implements java.io.Serializable {

	// Fields

	private PaymentP201705Id id;
	...
	/** default constructor */
	public PaymentP201705() {
	}

	/** full constructor */
	public PaymentP201705(PaymentP201705Id id, Customer customer, Rental rental, Staff staff) {
		this.id = id;
	...
	public PaymentP201705Id getId() {
		return this.id;
	}

	public void setId(PaymentP201705Id id) {
		this.id = id;
	}
