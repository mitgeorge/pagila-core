...
/**
 * PaymentP201701 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "payment_p2017_01", schema = "public")

public class PaymentP201701 implements java.io.Serializable {

	// Fields

	private PaymentP201701Id id;
	...
	/** default constructor */
	public PaymentP201701() {
	}

	/** full constructor */
	public PaymentP201701(PaymentP201701Id id, Customer customer, Rental rental, Staff staff) {
		this.id = id;
	...
	public PaymentP201701Id getId() {
		return this.id;
	}

	public void setId(PaymentP201701Id id) {
		this.id = id;
	}
