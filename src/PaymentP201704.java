...
/**
 * PaymentP201704 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "payment_p2017_04", schema = "public")

public class PaymentP201704 implements java.io.Serializable {

	// Fields

	private PaymentP201704Id id;
	...
	/** default constructor */
	public PaymentP201704() {
	}

	/** full constructor */
	public PaymentP201704(PaymentP201704Id id, Customer customer, Rental rental, Staff staff) {
		this.id = id;
	...
	public PaymentP201704Id getId() {
		return this.id;
	}

	public void setId(PaymentP201704Id id) {
		this.id = id;
	}
