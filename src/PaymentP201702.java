...
/**
 * PaymentP201702 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "payment_p2017_02", schema = "public")

public class PaymentP201702 implements java.io.Serializable {

	// Fields

	private PaymentP201702Id id;
	...
	/** default constructor */
	public PaymentP201702() {
	}

	/** full constructor */
	public PaymentP201702(PaymentP201702Id id, Customer customer, Rental rental, Staff staff) {
		this.id = id;
	...
	public PaymentP201702Id getId() {
		return this.id;
	}

	public void setId(PaymentP201702Id id) {
		this.id = id;
	}
