...
/**
 * PaymentP201704Id entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class PaymentP201704Id implements java.io.Serializable {
	...
	/** default constructor */
	public PaymentP201704Id() {
	}

	/** full constructor */
	public PaymentP201704Id(Integer paymentId, Short customerId, Short staffId, Integer rentalId, Double amount,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PaymentP201704Id))
			return false;
		PaymentP201704Id castOther = (PaymentP201704Id) other;
