...
/**
 * PaymentP201703 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "payment_p2017_03", schema = "public")

public class PaymentP201703 implements java.io.Serializable {

	// Fields

	private PaymentP201703Id id;
	...
	/** default constructor */
	public PaymentP201703() {
	}

	/** full constructor */
	public PaymentP201703(PaymentP201703Id id, Customer customer, Rental rental, Staff staff) {
		this.id = id;
	...
	public PaymentP201703Id getId() {
		return this.id;
	}

	public void setId(PaymentP201703Id id) {
		this.id = id;
	}
